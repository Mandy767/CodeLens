...
const DashboardNav: React.FC<DashboardNavProps> = ({ session }) => {
  ...
  return (
    <nav className="flex py-4 items-center justify-between w-full">
      <div
        className={`absolute z-10 justify-between px-4 w-[300px] border-r border-color4 transition-all top-0 left-0 duration-300 bg-color2 flex flex-col h-screen ${
      ...
      >
        <div className="flex py-4 items-center justify-between w-full">
          <button
            ...
            className="h-10 flex md:hidden rounded-lg px-2 text-color8"
          >
            <svg
              ...
              fill="none"
              viewBox="0 0 24 24"
              className="text-color8 stroke-[1.5] flex-shrink-0 h-6 w-6"
            >
              <path
                fill="currentColor"
                fillRule="evenodd"
          ...
          <button className="h-10 flex md:hidden rounded-lg px-2 text-color8">
            <svg
              ...
              fill="currentColor"
              viewBox="0 0 24 24"
              className="stroke-[2] flex-shrink-0 h-6 w-6"
            >
        ...
        <div className="w-full border-t border-t-color4 p-4 flex">
      ...
      >
        <motion.button
          ...
          className="rounded bg-transparent mb-3 hover:bg-color3 px-4 py-1 text-color8 flex gap-4 items-center"
        >
          {model?.title}
          <div
            className="arrow text-color8"
            style={{ transformOrigin: "50% 55%" }}
          >
            <svg width="15" height="15" viewBox="0 0 20 20">
              <path className=" fill-color8  " d="M0 7 L 20 7 L 10 16" />
            </svg>
          </div>
        </motion.button>
        <ul
          className="rounded absolute top-full w-max bg-color3 p-2 border border-color4 text-color7 flex flex-col gap-1"
          style={{
        ...
        >
          <li
            ...
            className="flex cursor-pointer hover:bg-color4 rounded p-3 grow items-center justify-between gap-8"
          >
            <div>
            ...
            <svg
              ...
              fill="none"
              viewBox="0 0 24 24"
              className={`stroke-[1.5] h-[18px] aspect-square flex-shrink-0 ${
                model?.title === "Chat-GPT" ? "flex" : "hidden"
              }`}
            >
              <path
                fill="currentColor"
          ...
          >
            ...
            <div className="h-[18px] aspect-square">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
                ...
                className={`stroke-[1.5] ${
                  model?.title === "Gemini" ? "flex" : "hidden"
                }`}
              >
                <path
                  fill="currentColor"
